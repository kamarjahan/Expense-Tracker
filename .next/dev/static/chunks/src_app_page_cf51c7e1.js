...
let app, auth, db;
if (("TURBOPACK compile-time value", "object") !== 'undefined' && !(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$app$2f$dist$2f$esm$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getApps"])().length) {
    try {
...
_s(AuthScreen, "MYbkX/nH/VXOYnSImSDTASSvkjA=");
_c = AuthScreen;
function App() {
    _s1();
    ...
    const [category, setCategory] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('Food');
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "App.useEffect": ()=>{
            ...
            const q = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["query"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["collection"])(db, 'users', user.uid, 'expenses'), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["orderBy"])('date', 'desc'), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["orderBy"])('createdAt', 'desc'));
            const unsubscribe = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["onSnapshot"])(q, {
                "App.useEffect.unsubscribe": (snapshot)=>{
                    const data = snapshot.docs.map({
                        "App.useEffect.unsubscribe.data": (doc)=>({
                                id: doc.id,
                                ...doc.data()
                            })
                    }["App.useEffect.unsubscribe.data"]);
                    setExpenses(data);
                    setLoading(false);
                }
            }["App.useEffect.unsubscribe"]);
    ...
    const handleSave = async (e)=>{
        ...
        try {
            const colRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["collection"])(db, 'users', user.uid, 'expenses');
            if (editItem) {
                const { createdAt, ...updatePayload } = payload; // Don't overwrite timestamp
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateDoc"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["doc"])(db, 'users', user.uid, 'expenses', editItem.id), updatePayload);
            } else {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addDoc"])(colRef, payload);
            }
            closeModal();
        } catch (err) {
    ...
    const stats = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "App.useMemo[stats]": ()=>{
            const income = expenses.filter({
                "App.useMemo[stats].income": (e)=>e.type === 'income'
            }["App.useMemo[stats].income"]).reduce({
                "App.useMemo[stats].income": (acc, curr)=>acc + curr.amount
            }["App.useMemo[stats].income"], 0);
            const expense = expenses.filter({
                "App.useMemo[stats].expense": (e)=>e.type === 'expense'
            }["App.useMemo[stats].expense"]).reduce({
                "App.useMemo[stats].expense": (acc, curr)=>acc + curr.amount
            }["App.useMemo[stats].expense"], 0);
            return {
                income,
                expense,
    ...
    const chartData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "App.useMemo[chartData]": ()=>{
            const expenseData = expenses.filter({
                "App.useMemo[chartData].expenseData": (e)=>e.type === 'expense'
            }["App.useMemo[chartData].expenseData"]);
            const grouped = expenseData.reduce({
                "App.useMemo[chartData].grouped": (acc, curr)=>{
                    acc[curr.category] = (acc[curr.category] || 0) + curr.amount;
                    return acc;
                }
            }["App.useMemo[chartData].grouped"], {});
            return Object.keys(grouped).map({
                "App.useMemo[chartData]": (key)=>({
                        name: key,
                        value: grouped[key],
                        color: CATEGORIES.find({
                            "App.useMemo[chartData]": (c)=>c.name === key
                        }["App.useMemo[chartData]"])?.color || '#ccc'
                    })
            }["App.useMemo[chartData]"]).sort({
                "App.useMemo[chartData]": (a, b)=>b.value - a.value
            }["App.useMemo[chartData]"]);
        }
    }["App.useMemo[chartData]"], [
        expenses
    ...
    if (!user) return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(AuthScreen, {}, void 0, false, {
        fileName: "[project]/src/app/page.js",
        lineNumber: 316,
        columnNumber: 21
    }, this);
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                onClick: ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$esm$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["signOut"])(auth),
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: expenses.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            lineNumber: 377,
                                            columnNumber: 17
                                        }, this) : expenses.map((item)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s1(App, "O1+Tld+Xg+BEOxq/OZboeekXDMk=");
_c1 = App;
var _c, _c1;
